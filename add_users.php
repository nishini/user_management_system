  ...
  if ($del_st == 1) {
    ...
    <script>
      swal({
        ...
        if (okay) {
          window.location.href = "add_other_products.php";
        }
      });
    </script>
    <?php
...
<script type="text/javascript">
  $(".btn_up").click(function() {
    ...
    $("#id_up").val(id);
      ...
      $.post("connection/add_other_products_fun.php", {
        get_dataset: "data",
        id: id
      }, function(data) {
        $("#p_name_up").val(data.p_name);
        $("#p_price_up").val(data.p_price);
        // $("#p_img_up").val(data.p_img);     
        $("#p_qnty_up").val(data.p_qnty);
  ...
  $("#edit").click(function() {
    ...
    var p_name_up = $("#p_name_up").val();
    var p_price_up = $("#p_price_up").val();
    var p_qnty_up = $("#p_qnty_up").val();
    var p_img_up = $("#p_img_up").val();
    var id_up = $("#id_up").val();
      // alert(id_up);
